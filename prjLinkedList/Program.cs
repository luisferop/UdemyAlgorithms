    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine("2 - Count the numbers of nodes");
                ...
                Console.WriteLine("13 - Bubble sort by exchange data");
                Console.WriteLine("14 - Bubble sort by exchange links");
                ...
                Console.WriteLine("19 - MergeSort TwoLists");
                ...
                switch (choice)
                {
                    ...
                    case 16:
                        {
                            Console.Write("Enter the element at which cycle has to be inserted : ");
                            data = Convert.ToInt32(Console.ReadLine());
